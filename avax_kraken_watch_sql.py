...
#  avax_block_numbers = cur.fetchall()
  ...
  print(everrise_rewards_avax)

  query = f"SELECT TimeStamp,AVAXRewards from avax_kraken_rewards ORDER BY TimeStamp desc limit 1"
  cur_remote.execute(query)
  previous_rewards_avax = cur_remote.fetchall()
  print(previous_rewards_avax)
#  current_rewards_avax = everrise_rewards_avax - previous_rewards_avax
