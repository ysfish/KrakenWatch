...
#  bsc_block_numbers = cur.fetchall()
  ...
  for item in bsc_internal_txns:
    ...
    if bsc_kraken_found == 1:
      ...
      cur.execute("INSERT INTO bsc_kraken_rewards (TimeStamp,BSCRewards) VALUES (?, ?)", (item['timeStamp'],everrise_rewards_bsc))
      conn.commit()

      cur_remote.execute("INSERT INTO bsc_kraken_rewards (TimeStamp,BSCRewards) VALUES (?, ?)", (item['timeStamp'],everrise_rewards_bsc))
      conn_remote.commit()
